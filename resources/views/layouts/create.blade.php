        ...
        <nav class="navbar">
            ...
            <script>
                function jsmeOnLoad() {
                    ...
                    jsmeModalApplet = new JSApplet.JSME("jsme_modal_container", "360px", "340px");
                    ...
                    function searchSmiles(jsmeEvent) {
                        var jsme = jsmeEvent.src;
                        var molfile = jsme.molFile();
                        // console.log(molfile);
                        worker.postMessage({ 'cmd': 'query', 'msg': molfile });
                    ...
                    jsmeModalApplet.setAfterStructureModifiedCallback(showSmiles);
                }
